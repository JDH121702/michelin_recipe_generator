...
class RecipeGenerator:
    ...
    def generate_recipe(self, params):
        ...
        prompt = self._construct_prompt(params)
    ...
    def _format_recipe_as_html(self, recipe_text):
        ...
        # Close any open divs
        html += "</div>\n" * (html.count('<div class="chef-notes">') - html.count('</div>'))
        html += "</div>\n" * (html.count('<div class="substitutions">') - html.count('</div>'))
        html += "</div>\n" * (html.count('<div class="wine-pairing">') - html.count('</div>'))
